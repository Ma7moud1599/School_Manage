...
(function (global, factory) {
    ...
    var isThenable = function isThenable(arg) {
        return (
            (typeof arg === "undefined" ? "undefined" : _typeof(arg)) ===
                "object" && typeof arg.then === "function"
        );
    };
    ...
    var adaptInputValidator = function adaptInputValidator(legacyValidator) {
        return function adaptedInputValidator(inputValue, extraParams) {
            return legacyValidator.call(this, inputValue, extraParams).then(
                function () {
                    return undefined;
                },
    ...
    var getFocusableElements = function getFocusableElements() {
        var focusableElementsWithTabindex = Array.prototype.slice
            .call(
        ...
        var otherFocusableElements = Array.prototype.slice.call(
            getPopup().querySelectorAll(
    ...
    function withNoNewKeyword(ParentSwal) {
        ...
        NoNewKeywordSwal.prototype = _extends(
    ...
    var isValidParameter = function isValidParameter(paramName) {
        return (
            defaultParams.hasOwnProperty(paramName) ||
    ...
    function withGlobalDefaults(ParentSwal) {
        var SwalWithGlobalDefaults = (function (_ParentSwal) {
            ...
            function SwalWithGlobalDefaults() {
                ...
                return possibleConstructorReturn(
                    this,
                    (
                        SwalWithGlobalDefaults.__proto__ ||
                        Object.getPrototypeOf(SwalWithGlobalDefaults)
                ...
                [
                    {
                        ...
                        value: function _main(params) {
                            return get(
                                SwalWithGlobalDefaults.prototype.__proto__ ||
                                    Object.getPrototypeOf(
                                        SwalWithGlobalDefaults.prototype
                                    ),
                                "_main",
                                this
                            ).call(this, _extends({}, defaults$1, params));
                        },
                    },
                ],
                [
        ...
        if (
            ...
            _typeof(window._swalDefaults) === "object"
        ) {
            ...
            (function (_Swal) {
                ...
                function MixinSwal() {
                    ...
                    return possibleConstructorReturn(
                        ...
                        (
                            MixinSwal.__proto__ ||
                            Object.getPrototypeOf(MixinSwal)
                        ).apply(this, arguments)
                    );
                }
                ...
                createClass(MixinSwal, [
                    {
                        ...
                        value: function _main(params) {
                            return get(
                                MixinSwal.prototype.__proto__ ||
                                    Object.getPrototypeOf(MixinSwal.prototype),
                                "_main",
                                this
            ...
            case "radio":
                return (
                    domCache.popup.querySelector(
                        "." + swalClasses.radio + " input:checked"
                    ) ||
                    domCache.popup.querySelector(
                        "." + swalClasses.radio + " input:first-child"
                    )
                );
            case "range":
                return domCache.popup.querySelector(
                    "." + swalClasses.range + " input"
                );
            default:
    ...
    function showValidationError(error) {
        ...
        domCache.validationError.style.marginLeft =
            "-" + popupComputedStyle.getPropertyValue("padding-left");
        domCache.validationError.style.marginRight =
    ...
    function setParameters(params) {
        ...
        if (!params.inputValidator) {
            Object.keys(defaultInputValidators).forEach(function (key) {
                if (params.input === key) {
                    params.inputValidator = params.expectRejections
                        ? defaultInputValidators[key]
                        : Swal.adaptInputValidator(defaultInputValidators[key]);
                }
            });
        }
        ...
        if (params.type) {
            ...
            var icon = popup.querySelector(
                "." + swalClasses.icon + "." + iconTypes[params.type]
            );
            show(icon);
        ...
        return new Promise(function (resolve, reject) {
            ...
            var succeedWith = function succeedWith(value) {
                constructor.closePopup(
                    innerParams.onClose,
                    innerParams.onAfterClose
                ); // TODO: make closePopup an *instance* method
            ...
            var confirm = function confirm(value) {
                ...
                if (innerParams.preConfirm) {
                    ...
                    var preConfirmPromise = Promise.resolve().then(function () {
                        return innerParams.preConfirm(
                            value,
                            innerParams.extraParams
                        );
                    });
                    if (innerParams.expectRejections) {
                        ...
                        preConfirmPromise.then(
                            function (preConfirmValue) {
                                if (
                                    isVisible(domCache.validationError) ||
            ...
            var handleKeyDown = function handleKeyDown(event) {
                ...
                if (e.key === "Enter" && !e.isComposing) {
                    if (e.target === _this.getInput()) {
                        if (
                            ["textarea", "file"].indexOf(innerParams.input) !==
                            -1
                        ) {
            ...
            for (var _i3 = 0; _i3 < inputTypes.length; _i3++) {
                ...
                var inputContainer = getChildByClass(
                    domCache.content,
                    inputClass
                );
                ...
                if (input) {
                    ...
                    for (var attr in innerParams.inputAttributes) {
                        input.setAttribute(
                            attr,
                            innerParams.inputAttributes[attr]
                        );
                    }
                }
            ...
            switch (innerParams.input) {
                ...
                case "select":
                    ...
                    populateInputOptions = function populateInputOptions(
                        inputOptions
                    ) {
                        inputOptions.forEach(function (_ref) {
                            ...
                            if (
                                innerParams.inputValue.toString() ===
                ...
                case "radio":
                    ...
                    populateInputOptions = function populateInputOptions(
                        ...
                        inputOptions.forEach(function (_ref3) {
                            ...
                            radioLabelElement.insertBefore(
                                radioInput,
                                radioLabelElement.firstChild
                            );
            ...
            if (
                innerParams.input === "select" ||
                innerParams.input === "radio"
            ) {
                var processInputOptions = function processInputOptions(
                    inputOptions
                ) {
                    return populateInputOptions(
                ...
                isThenable(innerParams.inputValue)
            ) {
                constructor.showLoading();
                hide(input);
            ...
            openPopup(
                innerParams.animation,
                innerParams.onBeforeOpen,
                innerParams.onOpen
            );
