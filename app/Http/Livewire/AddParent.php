...
class AddParent extends Component
{
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'Phone_Father' => 'required|string|min:10|max:10|regex:/[0-9]{9}/',
            'National_ID_Mother' => 'required|string|min:10|max:10|regex:/[0-9]{9}/',
            'Passport_ID_Mother' => 'min:10|max:10',
            'Phone_Mother' => 'required|string|min:10|max:10|regex:/[0-9]{9}/'
        ]);
    }
    ...
    public function firstStepSubmit()
    {
        $this->validate([
            ...
            'Phone_Father' => 'required|unique:my__parents,Passport_ID_Father,' . $this->id,
    ...
    public function secondStepSubmit()
    {
        ...
        $this->validate([
            ...
            'Phone_Mother' => 'required|unique:my__parents,Passport_ID_Mother,' . $this->id,
            'Job_Mother' => 'required',
