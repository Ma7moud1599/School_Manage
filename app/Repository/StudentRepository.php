...
class StudentRepository implements StudentRepositoryInterface
{
    public function Get_Student()
    {
        ...
        return view('page.Students.index', compact('students'));
    }
    ...
    public function Edit_Student($id)
    {
        ...
        return view('page.Students.edit', $data, compact('Students'));
    }
    ...
    public function Create_Student()
    {
        ...
        $data['nationals'] = Nationality::all();
        $data['bloods'] = Type_Blood::all();
        return view('page.Students.add', $data);
    }

    public function Show_Student($id)
    {
        $Student = Student::findorfail($id);
        return view('page.Students.show', compact('Student'));
    }
