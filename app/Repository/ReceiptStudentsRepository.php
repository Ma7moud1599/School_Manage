...
class ReceiptStudentsRepository implements ReceiptStudentsRepositoryInterface
{
    ...
    public function index()
    {
        ...
        return view('page.Receipt.index', compact('receipt_students'));
    }

    public function show($id)
    {
        $student = Student::findorfail($id);
        return view('page.Receipt.add', compact('student'));
    }

    public function edit($id)
    {
        $receipt_student = ReceiptStudent::findorfail($id);
        return view('page.Receipt.edit', compact('receipt_student'));
    }
