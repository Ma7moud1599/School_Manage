    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Fees.index')}}">{{trans('Fees.study_fees')}}</a> </li>
                <li> <a href="{{route('Fees_Invoices.index')}}">{{trans('Fees.Invoices')}}</a> </li>
                <li> <a href="{{route('receipt_students.index')}}">{{trans('Fees.receipt')}}</a> </li>
                <li> <a href="{{route('ProcessingFee.index')}}">{{trans('Fees.exclude_fee')}}</a> </li>
                <li> <a href="{{route('Payment_students.index')}}">{{trans('Fees.voucher_exchange')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Exams-icon">
                <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans('main_trans.the_exams')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Quizzes.index')}}"> {{trans('main_trans.the_exams_list')}}</a> </li>
                <li> <a href="{{route('Questions.index')}}"> {{trans('main_trans.the_questions_list')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}"> {{trans('main_trans.the_bookes_list')}}</a> </li>
            </ul>
        </li>
