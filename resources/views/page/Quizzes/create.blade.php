                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('Questions.Subject')}} : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="subject_id">
                                                <option selected disabled>{{trans('Questions.Select_course')}}...</option>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="teacher_id">
                                                <option selected disabled>{{trans('Questions.Select_teacher')}}...</option>
