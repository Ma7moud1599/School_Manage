                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#edit{{ $Class->id }}" title="{{ trans('Grades_trans.Edit') }}"><i class="fa fa-edit mx-1"></i>{{ trans('Grades_trans.Edit') }}</button>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{ $Class->id }}" title="{{ trans('Grades_trans.Delete') }}"><i class="fa fa-trash mx-1"></i>{{ trans('Grades_trans.Delete') }}</button>
                                </td>
                            </tr>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <label for="Name_en" class="mr-sm-2">{{ trans('My_Classes_trans.Name_class_en') }}
                                                            :</label>
                                                        <input type="text" class="form-control" value="{{ $Class->getTranslation('Name_class', 'en') }}" name="Name_en" required>
                                                    </div>
                                                </div><br>
