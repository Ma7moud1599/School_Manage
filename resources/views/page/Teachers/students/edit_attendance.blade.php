    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Attendance.Modify_attendance')}} : {{$student->name}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('attendance.edit','test')}}" method="post">
                    ...
                    <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                        ...
                        <span class="text-success">{{ trans('Attendance.Absence') }}</span>
                    </label>
                    ...
                    <label class="ml-4 block text-gray-500 font-semibold">
                        ...
                        <span class="text-danger">{{ trans('Attendance.Presence') }}</span>
                    </label>
