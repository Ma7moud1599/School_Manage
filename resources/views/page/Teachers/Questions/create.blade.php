...
@section('css')
@section('title')
{{trans('Questions.add_question')}}@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title"> {{trans('Questions.the_answers')}} <span style="color: red; font-size: smaller"> {{trans('Questions.mark')}}</span> </label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('Questions.The_correct_answer')}}</label>
