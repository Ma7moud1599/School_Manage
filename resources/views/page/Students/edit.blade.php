                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="gender_id">
                                    ...
                                    <option value="{{$Gender->id}}"
                                        {{$Gender->id == $Students->gender_id ? 'selected' : ""}}>{{ $Gender->Name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="nationalitie_id">
                                    ...
                                    <option value="{{ $nal->id }}"
                                        {{$nal->id == $Students->nationalitie_id ? 'selected' : ""}}>{{ $nal->Name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="grade_id">
                                    ...
                                    <option value="{{ $Grade->id }}"
                                        {{$Grade->id == $Students->grade_id ? 'selected' : ""}}>{{ $Grade->Name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="classroom_id">
                                    <option value="{{$Students->classroom_id}}">{{$Students->classroom->Name_class}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="section_id">
                                    <option value="{{$Students->section_id}}"> {{$Students->section->Name_section}}
                                    </option>
                                </select>
                            </div>
                        </div>
