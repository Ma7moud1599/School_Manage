                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-danger">{{trans('Students_trans.previous_stage')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.academic_year')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.previous_row')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.previous_section')}}</th>
                                            <th class="alert-success">{{trans('Students_trans.current_stage')}}</th>
                                            <th class="alert-success">{{trans('Students_trans.current_year')}}</th>
                                            <th class="alert-success">{{trans('Students_trans.current_row')}}</th>
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                   <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#Delete_one{{$promotion->id}}">{{trans('Students_trans.Undo_student')}}</button>
