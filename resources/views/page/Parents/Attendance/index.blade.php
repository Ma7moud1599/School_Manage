...
@section('css')
    ...
    @section('title')
{{trans('Attendance.Attendance_absence_report')}}    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    @section('PageTitle')
                            ...
                            <div class="row">
                                ...
                                <div class="card-body datepicker-form">
                                    <div class="input-group" data-date-format="yyyy-mm-dd">
                                        ...
                                        <input class="form-control range-to date-picker-default" placeholder='{{trans('Attendance.Expiry_date')}}' type="text" required name="to">
                                    </div>
                                </div>
