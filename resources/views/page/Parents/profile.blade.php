...
@section('css')
@section('title')
{{trans('Parent_trans.Profile_personly')}} @stop
@endsection
@section('page-header')
<!-- breadcrumb -->
@section('PageTitle')
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-4">{{trans('Parent_trans.loco_parentis')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{route('profile.update.parent',$information->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{trans('Parent_trans.Username_Arabic')}}</p>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{trans('Parent_trans.Username_English')}}</p>
                                </div>
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <label class="form-check-label"
                                        for="exampleCheck1">{{trans('Parent_trans.Show_password')}}</label>
                                </div>
                            </div>
                            <hr>
